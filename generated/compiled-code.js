...
(function (CommandVessel) {
    ...
    function generateOverload() {
        return new PeriodicPattern(1, function (boss) {
            var SPEED = 20;
    ...
    function main() {
        return new CombinationPattern([
            new RepeatPattern(function () {
                return [new SimpleMove(WIDTH * 4 / 6, 0, 1000),
